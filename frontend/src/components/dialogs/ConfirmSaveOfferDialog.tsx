...
interface ConfirmSaveOfferDialogProps {
  open: boolean;
...
export default function ConfirmSaveOfferDialog({
  open,
  onOpenChange,
  onConfirm,
  offerName = "Kaffee Krumel",
}: ConfirmSaveOfferDialogProps) {
  return (
      ...
      >
        <DialogHeader className="items-center gap-2">
          ...
          <DialogDescription className="text-center text-base text-gray-600">
            Please confirm if you want to save the Offer record of {offerName}.
          </DialogDescription>
        </DialogHeader>
