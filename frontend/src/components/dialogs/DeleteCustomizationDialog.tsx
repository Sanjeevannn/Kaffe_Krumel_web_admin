...
interface DeleteCustomizationDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onConfirm: () => void;
}

export default function DeleteCustomizationDialog({
  open,
  onOpenChange,
  onConfirm,
}: DeleteCustomizationDialogProps) {
  return (
      ...
      >
        <DialogHeader className="items-center gap-3">
          ...
          <DialogTitle className="text-xl font-bold text-red-500">
            Confirm Customization Deletion
          </DialogTitle>
          <DialogDescription className="text-center text-base text-gray-600">
            Deleting this customization will permanently remove all associated
            groups and options. Do you want to continue?
          </DialogDescription>
        </DialogHeader>
