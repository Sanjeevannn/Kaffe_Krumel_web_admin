...
interface ConfirmSaveUserDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onConfirm: () => void;
}

export default function ConfirmSaveUserDialog({
  open,
  onOpenChange,
  onConfirm,
}: ConfirmSaveUserDialogProps) {
  return (
      ...
      >
        <DialogHeader className="items-center gap-2">
          ...
          <DialogDescription className="text-center text-base text-gray-600">
            Please confirm if you want to save the User record of Kaffee Krumel.
          </DialogDescription>
        </DialogHeader>
