...
interface ConfirmSaveBranchDialogProps {
  open: boolean;
...
export default function ConfirmSaveBranchDialog({
  open,
  onOpenChange,
  onConfirm,
  branchName = "Kaffee Krumel",
}: ConfirmSaveBranchDialogProps) {
  return (
      ...
      >
        <DialogHeader className="items-center gap-2">
          ...
          <DialogDescription className="text-center text-base text-gray-600">
            Please confirm if you want to save the branch record of {branchName}.
          </DialogDescription>
        </DialogHeader>
