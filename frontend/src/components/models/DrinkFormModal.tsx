  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        className="flex max-h-[min(92vh,640px)] w-[min(92vw,420px)] flex-col overflow-hidden rounded-3xl border-none p-0 shadow-xl"
      >
        <div className="flex shrink-0 flex-col gap-2.5 px-4 pt-4 sm:px-5 sm:pt-5">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-4 py-3 sm:px-5 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          {step === 1 ? (
        ...
        <div className="shrink-0 space-y-2 border-t border-[#E7E7E8] bg-white px-4 pt-3 pb-4 sm:px-5 sm:pb-5">
