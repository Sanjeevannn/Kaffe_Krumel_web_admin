...
interface ConfirmSaveCustomizationDialogProps {
  open: boolean;
...
export default function ConfirmSaveCustomizationDialog({
  open,
  onOpenChange,
  onConfirm,
  customizationName = "this customization",
}: ConfirmSaveCustomizationDialogProps) {
  return (
      ...
      >
        <DialogHeader className="items-center gap-2">
          ...
          <DialogDescription className="text-center text-base text-gray-600">
            Please confirm if you want to save the Customization of Kaffee
            Krumel.
          </DialogDescription>
        </DialogHeader>
